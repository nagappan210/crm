...
adminRouter.post(
  ...
  //#swagger.tags = ['Admin']
  //#swagger.parameters['name'] = {in:'formData',type:'string',required:true}
  controllerAdmin.createCandidateRoll
);
adminRouter.patch(
  "/editCandidateRoll",
  //#swagger.tags = ['Admin']
  //#swagger.parameters['id'] = {in:'formData',type:'string',required:true}
  //#swagger.parameters['name'] = {in:'formData',type:'string',required:true}
  controllerAdmin.editCandidateRoll
);

adminRouter.delete(
  "/deleteCandiateRoll",
  //#swagger.tags = ['Admin']
  //#swagger.parameters['id'] = {in:'query',type:'string',required:true}
  controllerAdmin.deleteCandidateRoll
);
